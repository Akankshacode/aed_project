...
public class javaMailPatient {
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recepient){
        try {
            ...
            message.setSubject("Appointment at Health First hospital scheduled");
            message.setText("Doctor's appointment has been scheduled on request of NGO. \nKindly contact the hospital for more details.");
            return message;
        } catch (Exception ex) {
            Logger.getLogger(javamailUtil.class.getName()).log(Level.SEVERE, null, ex);
        }
